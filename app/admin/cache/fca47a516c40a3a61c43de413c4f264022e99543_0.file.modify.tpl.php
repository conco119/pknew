<?php
/* Smarty version 3.1.30, created on 2018-06-30 23:39:52
  from "/Users/mtd/Sites/htaccess/app/admin/view/importedit/modify.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b37b2587405f0_02832422',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fca47a516c40a3a61c43de413c4f264022e99543' => 
    array (
      0 => '/Users/mtd/Sites/htaccess/app/admin/view/importedit/modify.tpl',
      1 => 1527434934,
      2 => 'file',
    ),
  ),
...
function content_5b37b2587405f0_02832422 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
                                    ...
                                    <td class="text-right"><?php echo number_format($_smarty_tpl->tpl_vars['list']->value['price_import']);?>
 đ</td>

                                    <td class="text-center"><input type="number" class="prod-number"
                                                                   id="proNumber<?php echo $_smarty_tpl->tpl_vars['list']->value['product_id'];?>
"
...
"></td>
                                    <td><?php echo $_smarty_tpl->tpl_vars['list']->value['unit_name'];?>
</td>

                                    <td class="text-right"
                                        id="proTotal<?php echo $_smarty_tpl->tpl_vars['list']->value['product_id'];?>
"><?php echo number_format($_smarty_tpl->tpl_vars['list']->value['total']);?>

                                        đ
                                    </td>
                                    <td class="text-right">
                                        <button class="btn btn-danger"
                                                onclick="DeleteProductBill(<?php echo $_smarty_tpl->tpl_vars['list']->value['product_id'];?>
)"><i
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" name="country" class="form-control col-md-10" readonly
                                               value="<?php echo $_smarty_tpl->tpl_vars['import']->value['code'];?>
"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input class="date-picker form-control col-md-7 col-xs-12"
                                               ...
                                               required="required" type="text" id="exportday" value="<?php echo $_smarty_tpl->tpl_vars['import']->value['date'];?>
">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <select name="suppliers_id" class="select2_single form-control" tabindex="-1"
                                            ...
                                            <option>Chọn nhà cung cấp</option><?php echo $_smarty_tpl->tpl_vars['out']->value['suppliers'];?>
</select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-12 col-xs-12">
                                        <input type="text" name="discount" class="form-control text-right"
                                               ...
                                               value="<?php echo $_smarty_tpl->tpl_vars['import']->value['discount'];?>
"/>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row form-group" id="prodFillter">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="FilterCate"
                                onchange="LoadProduct();"><?php echo $_smarty_tpl->tpl_vars['out']->value['categories'];?>
</select>
                    </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="FilterTrademark"
                                onchange="LoadProduct();"><?php echo $_smarty_tpl->tpl_vars['out']->value['trademarks'];?>
</select>
                    </div>
                </div>
...
js/wh.import_modify.js"><?php echo '</script'; ?>
>
