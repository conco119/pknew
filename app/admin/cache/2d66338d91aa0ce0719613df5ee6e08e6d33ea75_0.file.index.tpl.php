<?php
/* Smarty version 3.1.30, created on 2018-07-03 23:36:06
  from "/Users/mtd/Sites/htaccess/app/admin/view/export/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b3ba5f65392c5_83102963',
...
function content_5b3ba5f65392c5_83102963 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" disabled>
									...
									<td class='text-center'>
										<?php echo $_smarty_tpl->tpl_vars['list']->value['unit_name'];?>

									</td>
									<td class="text-center">
										<input type="number" class="prod-number" id="proNumber<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['list']->value['price']*number_format($_smarty_tpl->tpl_vars['list']->value['number']);?>
 đ</td>
									<td class="text-right"><button class="btn btn-danger" onclick="DeleteProductBill(<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
)">
...
foreach ($_from as $_smarty_tpl->tpl_vars['list']->value) {
?>
								<tr id="serNo<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
">
									<td>#</td>
									<td><?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
</td>
									<td class="text-right"><input type="text"  disabled class="prod-price" value="<?php echo number_format($_smarty_tpl->tpl_vars['list']->value['price']);?>
"></td>
									<td class="text-center"><input type="number" class="prod-number" id="serNumber<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
"
										onchange="ServiceUpdateNumber(<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
, this.value);" value="<?php echo $_smarty_tpl->tpl_vars['list']->value['number'];?>
">
									</td>
									<td class="text-right" id="serTotal<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
"><?php echo number_format(($_smarty_tpl->tpl_vars['list']->value['price']*$_smarty_tpl->tpl_vars['list']->value['number']));?>
 đ</td>
									<td class="text-right"><button type="button" class="btn btn-danger" onclick="DeleteServiceBill(<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
);">
											<i class="fa fa-times-circle"></i>
										</button>
									</td>
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-6">
												<input class="date-picker form-control col-md-7 col-xs-12"
													...
													value="<?php echo $_smarty_tpl->tpl_vars['value']->value['date'];?>
">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="select2_single form-control"
													...
													<?php echo $_smarty_tpl->tpl_vars['out']->value['customers'];?>
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="form-control" name="discount_type"
													onchange="SetExportValue('discount_type', this.value);"><?php echo $_smarty_tpl->tpl_vars['out']->value['discount'];?>
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-3 col-xs-9">
												<input type="text" class="form-control text-right"
													...
													value="<?php echo $_smarty_tpl->tpl_vars['value']->value['discount'];?>
" />
											</div>
										</div>
									</div>
									<div class="tab-pane" id="tab3">
										<div class="form-group">
											<div class="col-md-12 col-sm-12 col-xs-12"><textarea class="form-control" rows="3"  name="description" onchange="SetExportValue('description', this.value)"
													id='descriptionex' placeholder='Mô tả thêm...'> <?php echo $_smarty_tpl->tpl_vars['value']->value['description'];?>
</textarea>
											</div>
										</div>
									</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" name="payment"
									...
									value="<?php echo number_format($_smarty_tpl->tpl_vars['value']->value['payment']);?>
" />
...
js/wh.export.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>
	var print_id = '<?php if (isset($_SESSION['export_id']) && $_SESSION['export_id'] != '') {
echo $_SESSION['export_id'];
}?>';
<?php echo '</script'; ?>
>
