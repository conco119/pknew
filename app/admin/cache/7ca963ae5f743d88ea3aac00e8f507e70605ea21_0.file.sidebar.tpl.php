...
mc=patient"><i class="fa fa-user"></i>Bệnh nhân</a></li>
				<li> <a href="<?php echo $_smarty_tpl->tpl_vars['arg']->value['prefix_admin'];?>
mc=category&site=index"> <i style="width:26px;" class="glyphicon glyphicon-list-alt"></i>Danh mục bài viết</a></li>
				<li><a href="<?php echo $_smarty_tpl->tpl_vars['arg']->value['prefix_admin'];?>
mc=post&site=index"><i style="width:26px;" class="glyphicon glyphicon-list-alt"></i>    Quản lý bài viết</a></li>
				<li><a href="<?php echo $_smarty_tpl->tpl_vars['arg']->value['prefix_admin'];?>
