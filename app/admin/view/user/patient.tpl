      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <div class="h_content">
            ...
            <div class="form-group form-inline">
              <input type="search" class="left form-control" id="key" placeholder="Tên người dùng hoặc SDT" value="{$out.key}">
            </div>
              ...
              <table class="table table-striped table-hover projects">
                ...
                <tbody>
                  ...
                  <tr id="field{$data.id}">
                    ...
                    <td>{$data.phone}</td>
                    <td class="text-right">
                       <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#DeleteForm" onclick="LoadDeleteItem('user', {$data.id}, '', 'nhân viên');"><i class="fa fa-camera"></i></button>
