<?php
/* Smarty version 3.1.30, created on 2018-07-03 23:24:21
  from "/Users/mtd/Sites/htaccess/app/site/view/product/detail.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b3ba335b76561_08463607',
...
function content_5b3ba335b76561_08463607 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
    <div class="col-md-5 col-sm-5 col-xs-12 mar-top">
        <ul id="etalage">
            <li>
                <img class="etalage_thumb_image" src="<?php echo base_url($_smarty_tpl->tpl_vars['value']->value['images'][0]['path']);?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['images'][0]['name'];?>
" width="90%">
                <img class="etalage_source_image target" src="<?php echo base_url($_smarty_tpl->tpl_vars['value']->value['images'][0]['path']);?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['images'][0]['name'];?>
" width="90%">
            </li>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['k']->value != 0) {?>
                    <li>
                        <img class="etalage_thumb_image" src="<?php echo base_url($_smarty_tpl->tpl_vars['list']->value['path']);?>
/<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
" width="100%">
                        <img class="etalage_source_image target" src="<?php echo base_url($_smarty_tpl->tpl_vars['list']->value['path']);?>
/<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
" width="100%">
                    </li>
                <?php }?>
...
?>
        ...
        <img class="block-mobile" src="<?php echo base_url($_smarty_tpl->tpl_vars['value']->value['images'][0]['path']);?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['images'][0]['name'];?>
" width="100%" >
    </div>
...
đ
            ...
            <div class="show-small-info">
                <p>Bảo hành:  <b style='color:red'> <?php echo $_smarty_tpl->tpl_vars['value']->value['warranty'];?>
 tháng </b></p>
            </div>
